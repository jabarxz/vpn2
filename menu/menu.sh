...
echo -e "${BIYellow}□ AutoScript By Dev   = Wak ${GREEN}( jabarxz )${NC}"

echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BICyan} │         ${BIWhite}${UWhite}jabarxz TUNNELING${NC}     ${BICyan}│${NC}"
echo -e "${BICyan} │                                                     │${NC}"
...
13) clear ; slow ;;
99) clear ; clearcache ;;
6969) clear ; wget https://raw.githubusercontent.com/jabarxz/vpn2/main/update.sh && chmod +x update.sh && ./update.sh && rm -f /root/update.sh ;;
0) clear ; menu ;;
x) exit ;;
